...
export function MacbookModel(props: React.JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, scene } = useGLTF('/models/macbook-transformed.glb') as unknown as MyGLTFResult
  ...
  useEffect(() => {
    scene.traverse((child) => {
      ...
      (child as THREE.Mesh<THREE.BufferGeometry, THREE.MeshStandardMaterial>).material.color.set(new THREE.Color("#adb5bd"));
